...
const users_dto_1 = require("../../../dto/users/users.dto");
...
let UsersController = class UsersController {
    ...
    setUpdateUser(id, dto) {
        if (!Object.keys(dto).length) {
            throw new common_1.BadRequestException('Нет данных о пользователе');
        }
...
__decorate([
    ...
    __metadata("design:returntype", void 0)
], UsersController.prototype, "setUpdateUser", null);
__decorate([
